      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4">
            <h3 className="text-xl font-bold mb-4">Events Society</h3>
            <p className="text-gray-300 mb-4">
              We are dedicated to organizing and hosting exciting events for our community. 
              Join us in creating memorable experiences and building lasting connections.
            </p>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/team" className="text-gray-300 hover:text-white transition duration-300">
                  Team
                </Link>
              </li>
              <li>
                <Link to="/event" className="text-gray-300 hover:text-white transition duration-300">
                  Event
                </Link>
              </li>
            </ul>
            ...
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-center gap-2">
                <a href="mailto:eventssociety.klsac@gmail.com" className="flex items-center gap-2 hover:text-white transition duration-300">
                  ...
                  <span>eventssociety.klsac@gmail.com</span>
                </a>
              </li>
              <li className="flex items-center gap-2">
                <a href="tel:+1234567890" className="flex items-center gap-2 hover:text-white transition duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              ...
              <li className="flex items-center gap-2">
                <a href="#" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-white transition duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                  </svg>
                  <span>Green Fields,Guntur</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">&copy; {new Date().getFullYear()} Events Society. All rights reserved.</p>
