...
const Eventsinfo = () => {
  ...
  if (!event) {
    return (
      <div className="min-h-screen bg-black pt-20 md:pt-40 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-purple-900 pt-20 md:pt-40">
      <div className="container mx-auto px-4 py-4 md:py-8">
        {/* Back Button */}
        <button 
          onClick={() => navigate(-1)}
          className="text-white hover:text-purple-400 transition duration-300 mb-4 md:mb-8"
        >
        ...
        {/* Hero Section */}
        <div className="relative w-full md:w-[640px] h-[240px] md:h-[360px] mx-auto rounded-2xl overflow-hidden mb-8 md:mb-16 shadow-2xl">
          {event.images.map((image, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6">
                ...
                <p className="text-base md:text-xl text-gray-200">{image.caption}</p>
              </div>
            </div>
          ))}
          ...
          <div className="absolute inset-0 flex items-center justify-between p-2 md:p-4">
            <button onClick={prevSlide} className="p-1.5 md:p-2 rounded-full bg-white/20 hover:bg-white/30 backdrop-blur-sm transition">
              <svg className="w-4 h-4 md:w-6 md:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
              </svg>
            </button>
            <button onClick={nextSlide} className="p-1.5 md:p-2 rounded-full bg-white/20 hover:bg-white/30 backdrop-blur-sm transition">
              <svg className="w-4 h-4 md:w-6 md:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Slide Indicators */}
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-1.5 md:space-x-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8">
          ...
          <div className="lg:col-span-2 space-y-4 md:space-y-8">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 md:p-8">
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-4 md:mb-6">About the Event</h2>
              <p className="text-base md:text-lg text-gray-200 leading-relaxed">{event.description}</p>
            </div>

            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 md:p-8">
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-4 md:mb-6">Event Highlights</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                {event.highlights.map((highlight, index) => (
                  <div key={index} className="flex items-center space-x-3 md:space-x-4 text-gray-200">
                    <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 rounded-xl bg-purple-500/20 flex items-center justify-center">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 md:p-8 h-fit">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-6 md:mb-8">Event Details</h2>
            ...
            <div className="space-y-6 md:space-y-8">
              <div className="flex items-start space-x-4 md:space-x-6">
                ...
                <div>
                  ...
                  <p className="text-base md:text-lg text-white">{event.venue}</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 md:space-x-6">
                ...
                <div>
                  ...
                  <p className="text-base md:text-lg text-white">{event.date}</p>
                  <p className="text-base md:text-lg text-white">{event.time}</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 md:space-x-6">
                ...
                <div>
                  ...
                  <p className="text-base md:text-lg text-white">{event.attendees}</p>
                </div>
              </div>
            </div>
          </div>
